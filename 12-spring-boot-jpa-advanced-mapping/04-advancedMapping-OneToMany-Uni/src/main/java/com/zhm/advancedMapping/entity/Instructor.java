...
public class Instructor {
    ...
    // setCourses() used to set a list of courses to the instructor
    // but, suppose we want to add a single new course to this instructor's current course list then?
