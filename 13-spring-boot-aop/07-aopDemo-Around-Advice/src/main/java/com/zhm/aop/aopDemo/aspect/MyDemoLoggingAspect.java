...
//    public void declaration(){}
    ...
    @After("execution(* com.zhm.aop.aopDemo.DAO.AccountDAO.findAccounts(..))")
    public void afterFindAccountsAdvice(){
        System.out.println("We are now in the method annotated with @After");
    }

    @Around("execution(* com.zhm.aop.aopDemo.service.TrafficFortuneService.getFortune())")
    public Object aroundGetFortune(ProceedingJoinPoint theProceedingJoinPoint) throws Throwable{

        // print out method we are coming from
        ...
        System.out.println("The method runs for : " + (total / 1000) + " seconds");
    ...
    /*
    @Around("execution(* com.zhm.aop.aopDemo.service.TrafficFortuneService.getFortune(..))")
    public Object aroundExceptionHandlingGetFortune(ProceedingJoinPoint theProceedingJoinPoint) throws Throwable{
        ...
        // now, let's execute the method and handle if exception is present
        Object result = null;
        try{
